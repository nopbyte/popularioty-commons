package popularioty.commons.exception;
...
public class PopulariotyException extends Exception
{
	 ...
	 */
	public PopulariotyException(String message, Throwable cause, Logger classLogger, String loggingMessage, Level level, int HTTPErrorCode )
	{
		super(message, cause);
		this.internal = true;
	 ...
	 */
	public PopulariotyException(String message, Logger classLogger, Map<String,Object> externalError, Level level, int HTTPErrorCode)
	{
		super(message);
		this.internal = false;
